Feature: Zonnic Canada guest login flows
  ...
  @zonnicCALive
  Scenario: Guest Sign In with invalid email and password | Valid email and password
    ...
    Then user signs in with customer properties 'loginValidEmailProd' 'loginValidPassword.key' as 'guestUser'